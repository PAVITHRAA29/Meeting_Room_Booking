...
function getSlotMetrics(_ref2) {
  ...
  function positionFromDate(date) {
    var startOfDay = localizer.startOf(date, 'day');
    var diff = localizer.diff(startOfDay, date, 'minutes') + localizer.getDstOffset(startOfDay, date);
  ...
  _createClass(DayColumn, [{
    ...
    value: function render() {
      var _this$props4 = this.props,
        ...
        isNow = _this$props4.isNow,
        resource = _this$props4.resource,
        accessors = _this$props4.accessors,
        localizer = _this$props4.localizer,
        _this$props4$getters = _this$props4.getters,
        dayProp = _this$props4$getters.dayProp,
        getters = _objectWithoutProperties(_this$props4$getters, _excluded$5),
        _this$props4$componen = _this$props4.components,
        EventContainer = _this$props4$componen.eventContainerWrapper,
        components = _objectWithoutProperties(_this$props4$componen, _excluded2$1);
      ...
      }, /*#__PURE__*/React.createElement("span", null, localizer.format(selectDates, 'selectRangeFormat'))), /*#__PURE__*/React.createElement("div", {
